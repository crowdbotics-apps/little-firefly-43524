"""
Django settings for little_firefly_43524 project.
...
ROOT_URLCONF = 'little_firefly_43524.urls'
...
WSGI_APPLICATION = 'little_firefly_43524.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_firefly_43524 API",
    "DESCRIPTION": "API documentation for little_firefly_43524 App",
    "VERSION": "v1",
}
